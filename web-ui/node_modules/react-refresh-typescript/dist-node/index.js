  ...
  return context => {
    ...
    function visitTopLevel(usedAsJSXElement, hooksSignatureMap, node) {
      if (ts.isFunctionDeclaration(node)) {
        ...
        if (isHigherOrderComponentLike(node.expression)) {
          ...
          return [factory.updateExportAssignment(node, node.modifiers, factory.createAssignment(temp, call)), createComponentRegisterCall(temp, '%default%'), ...registers];
    ...
    function registerComponent(name) {
      if (!startsWithLowerCase(name.text)) {
        ...
        const assignment = factory.createAssignment(temp, name); // $reg$(uniq, "name")
