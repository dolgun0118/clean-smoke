...
const HomeTemlpate = () => {
  ...
  useEffect(() => {
    ...
    // const options = {
    //   //지도를 생성할 때 필요한 기본 옵션
    //   center: new kakao.maps.LatLng(37.4850998, 126.923322), //지도의 중심좌표.
    ...
    function searchPlaces() {
      let keyword = "서울특별시 용산구 한남빌딩 5층 외부";
  ...
  // const markerPosition = new kakao.maps.LatLng(37.4850998, 126.923322);
  ...
  return (
    <>
      <div
        className="home-contents w-full h-full items-center justify-center flex bg-slate-200 text-fuchsia-500"
        role="local-navi-bar"
      >
